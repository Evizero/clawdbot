/**
 * Core Bridge for MS Teams Voice Call Plugin
 *
 * Provides access to Clawdbot core modules for session persistence.
 * Copied from voice-call extension with minimal adaptations.
 */
...
export async function loadCoreAgentDeps(): Promise<CoreAgentDeps> {
  ...
  coreDepsPromise = (async () => {
    const [
      ...
      importCoreModule<{
        recordInboundSession: CoreAgentDeps["recordInboundSession"];
      }>("channels/session.js"),
    ]);
